    ...
    <div className='space-y-3 p-4 border rounded-3xl border-gray/20'>
      ...
      <div className='flex justify-between items-center'>
        ...
        <div className="link flex gap-2 items-center">
          <Link target='_blank' href="https://github.com/hibnastiar27" className='github bg-primary dark:bg-white w-10 h-10 rounded-full flex justify-center items-center'>
            <LogoGithub />
          </Link>
          <Link target='_blank' href="" className='demo bg-primary dark:bg-white w-10 h-10 rounded-full flex justify-center items-center'>
